...
tic;
animal_name = 'M3';
time_name = 'PostRT_30m'; %'PreRT'or 'PostRT' or 'PostRT_30m'
...
if (strcmp(time_name,'PreRT'))
    [dist_T2_z1_pre,mean_T2_z1_pre] = BOLD_contour(animal_name,time_name,T2sub_G(:,:,1),T2_est_air(:,:,1),'T2_z1');
    [dist_T2_z2_pre,mean_T2_z2_pre] = BOLD_contour(animal_name,time_name,T2sub_G(:,:,2),T2_est_air(:,:,2),'T2_z2');
    [dist_T2_z3_pre,mean_T2_z3_pre] = BOLD_contour(animal_name,time_name,T2sub_G(:,:,3),T2_est_air(:,:,3),'T2_z3');
elseif (strcmp(time_name,'PostRT_10m'))
    [dist_T2_z1_post_10,mean_T2_z1_post_10] = BOLD_contour(animal_name,time_name,T2sub_G(:,:,1),T2_est_air(:,:,1),'T2_z1');
    [dist_T2_z2_post_10,mean_T2_z2_post_10] = BOLD_contour(animal_name,time_name,T2sub_G(:,:,2),T2_est_air(:,:,2),'T2_z2');
    [dist_T2_z3_post_10,mean_T2_z3_post_10] = BOLD_contour(animal_name,time_name,T2sub_G(:,:,3),T2_est_air(:,:,3),'T2_z3');
elseif (strcmp(time_name,'PostRT_30m'))
    [dist_T2_z1_post_30,mean_T2_z1_post_30] = BOLD_contour(animal_name,time_name,T2sub_G(:,:,1),T2_est_air(:,:,1),'T2_z1');
    [dist_T2_z2_post_30,mean_T2_z2_post_30] = BOLD_contour(animal_name,time_name,T2sub_G(:,:,2),T2_est_air(:,:,2),'T2_z2');
    [dist_T2_z3_post_30,mean_T2_z3_post_30] = BOLD_contour(animal_name,time_name,T2sub_G(:,:,3),T2_est_air(:,:,3),'T2_z3');
else
    return;
end
